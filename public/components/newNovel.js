...
NewNovel.load = async function (root) {
    ...
    $form.addEventListener('submit', async (e) => {
        ...
        let createdNovels = [novelRef.id];

        if (root.user.createdNovels && root.user.createdNovels.length) {
            root.user.createdNovels.unshift(novelRef.id);
            createdNovels = root.user.createdNovels;
        }
